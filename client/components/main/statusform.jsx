Statusform = React.createClass({
  ...
  submitForm(e){
    ...
    Meteor.call("Posts.insert", message, imageid, imageurl,  function(error, result){
      if(error){
          ...
          <form onSubmit={this.submitForm} className="form center-block">
            ...
            <div className="panel-body">
              <div className="form-group">
                <textarea id="sharing" ref="sharing" placeholder="What do you want to share?" className="form-control">
